                ...
                <nav className="navbar navbar-expand-lg navbar-light ">
                    ...
                    <div className="collapse navbar-collapse " id="navbarNav">
                        ...
                        <span className='d-block ml-auto text-center'>
                            {/* <a href="https://twitter.com/LazyBTCBULLDOGClub" target="_blank"><i className="fab fa-twitter mx-2 py-3 icons"></i></a>
                            <a href="https://discord.gg/kPAZkJpZsA" target="_blank"><i className="fab fa-discord mx-2 py-3 icons"></i></a>
                            <a href="https://www.instagram.com/lazyBTCBULLDOGclub/ " target="_blank"><i className="fab fa-instagram mx-2 py-3 icons"></i></a> */}
                        </span>
                    </div>
                </nav>
            </div>
